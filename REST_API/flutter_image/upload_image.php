...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_FILES["image"]) && isset($_POST["description"])) {
        ...
        if (move_uploaded_file($image["tmp_name"], $uploadPath)) {
            ...
            $filePath = $_SERVER['DOCUMENT_ROOT'] . '/' . "flutter_image/" . $uploadPath;

            $sql = "INSERT INTO uploaded_images (file_name, name, description, file_path) VALUES ('$imageName', '$name', '$description', '$filePath')";
    ...
    if($result) {
        ...
        echo "Error: " . $conn->error; // Menampilkan pesan kesalahan dari MySQL jika ada kesalahan dalam query
    }
} else {
    // Method not allowed
